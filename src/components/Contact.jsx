  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action='https://getform.io/f/970d252d-efdf-43f2-978e-4c55aaceceb3' className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className='text-white border-2 rounded-md hover:bg-[#03fa6e] hover:border-[#03fa6e] px-4 py-3 my-8 mx-auto flex items-center transition ease-in-out duration-500'>Submit</button>
        </form>
